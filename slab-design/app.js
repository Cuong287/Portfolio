...
function renderMaterial() { const m = material(); $('#material-summary').innerHTML = `<dt>R<sub>b</sub></dt><dd>${m.rb.toFixed(2)} MPa</dd><dt>R<sub>bt</sub></dt><dd>${m.rbt.toFixed(2)} MPa</dd><dt>E<sub>b</sub></dt><dd>${m.eb.toLocaleString('en-US')} MPa</dd><dt>R<sub>s</sub></dt><dd>${m.rs} MPa</dd><dt>ξ<sub>R</sub></dt><dd>${m.xiR.toFixed(3)}</dd><dt>α<sub>R</sub></dt><dd>${m.alphaR.toFixed(3)}</dd>`; }
